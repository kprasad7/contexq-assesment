...
def validate_quality_metrics():
    ...
    bronze_data = pd.DataFrame({"col1": [1, 2, None, 4, 5], "col2": ["a", "b", "c", "d", "e"]})

    silver_data = pd.DataFrame({"col1": [1, 2, 3, 4, 5], "col2": ["a", "b", "c", "d", "e"]})

    gold_data = pd.DataFrame({"col1": [1, 2, 3, 4, 5], "col2": ["a", "b", "c", "d", "e"]})
